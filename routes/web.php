...
use App\Http\Livewire\PomodoroTimer;
...
use App\Http\Livewire\PositiveNews;
...
Route::get('pomodoro-timer', PomodoroTimer::class);
Route::get('positive-news', PositiveNews::class);
