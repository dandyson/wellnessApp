			...
			<aside class="app-sidebar sidebar-scroll">
				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" href="{{url('measurements')}}"><i class="fa fa-child ms-1 me-3"></i> <span class="side-menu__label">Body Measurements</span></a>
						</li>
						<li class="side-item side-item-category">News</li>
						<li class="slide">
							<a class="side-menu__item" href="{{url('positive-news')}}"><i class="si si-emotsmile me-3"></i> <span class="side-menu__label">Positive News</span></a>
						</li>
						<li class="side-item side-item-category">Journals</li>
						<li class="slide">
							<a class="side-menu__item" href="{{url('worry-journal')}}"><i class="si si-emotsmile me-3"></i> <span class="side-menu__label">Worry Journal</span></a>
						</li>
